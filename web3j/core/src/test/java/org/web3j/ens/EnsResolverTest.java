...
public class EnsResolverTest {
    ...
    public void testResolve() throws Exception {
        ...
        assertThat(ensResolver.resolve("web3j.aux"),
    ...
    public void testReverseResolve() throws Exception {
        ...
        String contractName =
                ...
                + TypeEncoder.encode(new Utf8String("web3j.aux"));
    ...
    public void testIsEnsName() {
        assertTrue(isValidEnsName("aux"));
        assertTrue(isValidEnsName("web3.aux"));
        assertTrue(isValidEnsName("0x19e03255f667bdfd50a32722df860b1eeaf4d635.aux"));
