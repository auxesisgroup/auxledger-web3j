...
public class JsonRpc2_0Web3j implements Web3j {
    ...
    @Override
    public Request<?, EthProtocolVersion> auxProtocolVersion() {
        return new Request<>(
                "eth_protocolVersion",
                Collections.<String>emptyList(),
                web3jService,
    ...
    @Override
    public Request<?, EthCoinbase> auxCoinbase() {
        return new Request<>(
                "eth_coinbase",
                Collections.<String>emptyList(),
                web3jService,
    ...
    @Override
    public Request<?, EthSyncing> auxSyncing() {
        return new Request<>(
                "eth_syncing",
                Collections.<String>emptyList(),
                web3jService,
    ...
    @Override
    public Request<?, EthMining> auxMining() {
        return new Request<>(
                "eth_mining",
                Collections.<String>emptyList(),
                web3jService,
    ...
    @Override
    public Request<?, EthHashrate> auxHashrate() {
        return new Request<>(
                "eth_hashrate",
                Collections.<String>emptyList(),
                web3jService,
    ...
    @Override
    public Request<?, EthGasPrice> auxGasPrice() {
        return new Request<>(
                "eth_gasPrice",
                Collections.<String>emptyList(),
                web3jService,
    ...
    @Override
    public Request<?, EthAccounts> auxAccounts() {
        return new Request<>(
                "eth_accounts",
                Collections.<String>emptyList(),
                web3jService,
    ...
    @Override
    public Request<?, EthBlockNumber> auxBlockNumber() {
        return new Request<>(
                "eth_blockNumber",
                Collections.<String>emptyList(),
                web3jService,
    ...
    @Override
    public Request<?, EthGetBalance> auxGetBalance(
    ...
    @Override
    public Request<?, EthGetStorageAt> auxGetStorageAt(
    ...
    @Override
    public Request<?, EthGetTransactionCount> auxGetTransactionCount(
            String address, DefaultBlockParameter defaultBlockParameter) {
        return new Request<>(
    ...
    @Override
    public Request<?, EthGetBlockTransactionCountByHash> auxGetBlockTransactionCountByHash(
            String blockHash) {
        return new Request<>(
    ...
    @Override
    public Request<?, EthGetBlockTransactionCountByNumber> auxGetBlockTransactionCountByNumber(
    ...
    @Override
    public Request<?, EthGetUncleCountByBlockHash> auxGetUncleCountByBlockHash(String blockHash) {
        return new Request<>(
    ...
    @Override
    public Request<?, EthGetUncleCountByBlockNumber> auxGetUncleCountByBlockNumber(
            DefaultBlockParameter defaultBlockParameter) {
        return new Request<>(
    ...
    @Override
    public Request<?, EthGetCode> auxGetCode(
            String address, DefaultBlockParameter defaultBlockParameter) {
        return new Request<>(
                "eth_getCode",
                Arrays.asList(address, defaultBlockParameter.getValue()),
    ...
    @Override
    public Request<?, EthSign> auxSign(String address, String sha3HashOfDataToSign) {
        return new Request<>(
                "eth_sign",
    ...
    @Override
    public Request<?, org.web3j.protocol.core.methods.response.EthCall> auxCall(
    ...
    @Override
    public Request<?, EthEstimateGas> auxEstimateGas(Transaction transaction) {
        return new Request<>(
                "eth_estimateGas",
                Arrays.asList(transaction),
                web3jService,
    ...
    @Override
    public Request<?, EthBlock> auxGetBlockByHash(
    ...
    @Override
    public Request<?, EthBlock> auxGetBlockByNumber(
            DefaultBlockParameter defaultBlockParameter,
    ...
    @Override
    public Request<?, EthTransaction> auxGetTransactionByHash(String transactionHash) {
        return new Request<>(
    ...
    @Override
    public Request<?, EthTransaction> auxGetTransactionByBlockHashAndIndex(
    ...
    @Override
    public Request<?, EthTransaction> auxGetTransactionByBlockNumberAndIndex(
    ...
    @Override
    public Request<?, EthGetTransactionReceipt> auxGetTransactionReceipt(String transactionHash) {
        return new Request<>(
    ...
    @Override
    public Request<?, EthBlock> auxGetUncleByBlockHashAndIndex(
            String blockHash, BigInteger transactionIndex) {
        return new Request<>(
    ...
    @Override
    public Request<?, EthBlock> auxGetUncleByBlockNumberAndIndex(
    ...
    @Override
    public Request<?, EthGetCompilers> auxGetCompilers() {
        return new Request<>(
                "eth_getCompilers",
                Collections.<String>emptyList(),
                web3jService,
    ...
    @Override
    public Request<?, EthCompileLLL> auxCompileLLL(String sourceCode) {
        return new Request<>(
                "eth_compileLLL",
    ...
    @Override
    public Request<?, EthCompileSolidity> auxCompileSolidity(String sourceCode) {
        return new Request<>(
                "eth_compileSolidity",
                Arrays.asList(sourceCode),
                web3jService,
    ...
    @Override
    public Request<?, EthCompileSerpent> auxCompileSerpent(String sourceCode) {
        return new Request<>(
                "eth_compileSerpent",
                Arrays.asList(sourceCode),
                web3jService,
    ...
    @Override
    public Request<?, EthFilter> auxNewFilter(
    ...
    @Override
    public Request<?, EthFilter> auxNewBlockFilter() {
        return new Request<>(
                "eth_newBlockFilter",
                Collections.<String>emptyList(),
                web3jService,
    ...
    @Override
    public Request<?, EthFilter> auxNewPendingTransactionFilter() {
        return new Request<>(
    ...
    @Override
    public Request<?, EthUninstallFilter> auxUninstallFilter(BigInteger filterId) {
        return new Request<>(
                "eth_uninstallFilter",
    ...
    @Override
    public Request<?, EthLog> auxGetFilterChanges(BigInteger filterId) {
        return new Request<>(
    ...
    @Override
    public Request<?, EthLog> auxGetFilterLogs(BigInteger filterId) {
        return new Request<>(
                "eth_getFilterLogs",
                Arrays.asList(Numeric.toHexStringWithPrefixSafe(filterId)),
                web3jService,
    ...
    @Override
    public Request<?, EthLog> auxGetLogs(
            org.web3j.protocol.core.methods.request.EthFilter ethFilter) {
        return new Request<>(
                "eth_getLogs",
                Arrays.asList(ethFilter),
    ...
    @Override
    public Request<?, EthGetWork> auxGetWork() {
        return new Request<>(
                "eth_getWork",
                Collections.<String>emptyList(),
                web3jService,
    ...
    @Override
    public Request<?, EthSubmitWork> auxSubmitWork(
    ...
    @Override
    public Request<?, EthSubmitHashrate> auxSubmitHashrate(String hashrate, String clientId) {
        return new Request<>(
                "eth_submitHashrate",
    ...
    @Override
    public Flowable<String> auxBlockHashFlowable() {
        return web3jRx.auxBlockHashFlowable(blockTime);
    }

    @Override
    public Flowable<String> auxPendingTransactionHashFlowable() {
        return web3jRx.auxPendingTransactionHashFlowable(blockTime);
    }

    @Override
    public Flowable<Log> auxLogFlowable(
            org.web3j.protocol.core.methods.request.EthFilter ethFilter) {
        return web3jRx.auxLogFlowable(ethFilter, blockTime);
    }
