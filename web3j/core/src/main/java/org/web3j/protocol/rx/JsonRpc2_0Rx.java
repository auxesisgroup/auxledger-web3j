...
public class JsonRpc2_0Rx {
    ...
    public Flowable<String> auxBlockHashFlowable(long pollingInterval) {
    ...
    public Flowable<String> auxPendingTransactionHashFlowable(long pollingInterval) {
        return Flowable.create(subscriber -> {
    ...
    public Flowable<Transaction> pendingTransactionFlowable(long pollingInterval) {
        return auxPendingTransactionHashFlowable(pollingInterval)
                .flatMap(transactionHash ->
                        web3j.auxGetTransactionByHash(transactionHash).flowable())
    ...
    public Flowable<EthBlock> blockFlowable(
        ...
        return auxBlockHashFlowable(pollingInterval)
                .flatMap(blockHash ->
                        web3j.auxGetBlockByHash(blockHash, fullTransactionObjects).flowable());
    }
    ...
    private Flowable<EthBlock> replayBlocksFlowableSync(
        ...
        if (ascending) {
            return Flowables.range(startBlockNumber, endBlockNumber)
                    .flatMap(i -> web3j.auxGetBlockByNumber(
    ...
    private BigInteger getBlockNumber(
        ...
        if (defaultBlockParameter instanceof DefaultBlockParameterNumber) {
            ...
            EthBlock latestEthBlock = web3j.auxGetBlockByNumber(
